...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { content: @slide.content, layout: @slide.layout, link: @slide.link, link_title: @slide.link_title, title: @slide.title, upload: @slide.upload }
    end
  ...
  test "should update slide" do
    put :update, id: @slide, slide: { content: @slide.content, layout: @slide.layout, link: @slide.link, link_title: @slide.link_title, title: @slide.title, upload: @slide.upload }
    assert_redirected_to slide_path(assigns(:slide))
  end
